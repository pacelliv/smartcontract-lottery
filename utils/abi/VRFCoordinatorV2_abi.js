const vrfCoordinator_abi = [
    ...
    { inputs: [], name: "TooManyConsumers", type: "error" },
    {
        ...
        inputs: [
            ...
            { indexed: false, internalType: "uint32", name: "stalenessSeconds", type: "uint32" },
            {
                indexed: false,
                internalType: "uint32",
    ...
    {
        inputs: [{ internalType: "uint64", name: "reqCount", type: "uint64" }],
        name: "getFeeTier",
        outputs: [{ internalType: "uint32", name: "", type: "uint32" }],
        stateMutability: "view",
        type: "function",
    ...
    },
    {
        inputs: [
            ...
            { internalType: "uint256[2]", name: "publicProvingKey", type: "uint256[2]" },
        ],
    ...
    },
    {
        inputs: [
            ...
            { internalType: "uint32", name: "stalenessSeconds", type: "uint32" },
            { internalType: "uint32", name: "gasAfterPaymentCalculation", type: "uint32" },
            { internalType: "int256", name: "fallbackWeiPerUnitLink", type: "int256" },
            {
                components: [
                    {
                        internalType: "uint32",
