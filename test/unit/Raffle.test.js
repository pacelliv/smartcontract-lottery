    ...
    : describe("Raffle Unit Tests", () => {
          ...
          describe("performUpkeep", () => {
              ...
              it("updates the raffle state, emits RequestedRaffleWinner and calls the vrfCoordinator", async () => {
                  ...
                  // If look inside VRFCoordinatorV2Mock.sol, I will see that If I call requestRandomWords() from this mock
                  // it also emits an event with randomWords requested -- this means that the emitted event in my contract is
                  // redundant (line 152), but for educational purposes I will leave it there.
                  // The event in the zeroed index is "uint256 requestId = i_vrfCoordinator.requestRandomWords()",
                  // that's why we need the event in the index 1.
